...
const mockOrders = [
  { id: "ORD-001", date: "2025-01-15", amount: 419.97, status: "Delivered" },
  { id: "ORD-002", date: "2025-01-10", amount: 229.98, status: "Shipped" },
  { id: "ORD-003", date: "2025-01-08", amount: 99.99, status: "Pending" },
]

const mockWishlist = [
  { id: 1, name: "Premium Cashmere Sweater", price: 189.99, image: "/luxury-cashmere-sweater.jpg" },
  { id: 2, name: "Designer Black Jeans", price: 129.99, image: "/designer-shoes.jpg" },
]
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 md:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold mb-8 fade-in-up">My Account</h1>
        ...
        {activeTab === "profile" && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 scroll-reveal">
              <ProfileForm profileData={profileData} onProfileChange={handleProfileChange} />
            </div>
            ...
            {mockWishlist.map((item, index) => (
              <div key={item.id} className="scroll-reveal" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="bg-card border border-border rounded-lg overflow-hidden card-lift group">
                  ...
                  <div className="p-4">
                    <p className="font-semibold text-foreground text-sm line-clamp-2 mb-2">{item.name}</p>
