      ...
      <>
        ...
        <main className="min-h-screen bg-background py-16">
          <div className="max-w-2xl mx-auto px-4 text-center">
            ...
            <p className="text-foreground/60 mb-8">Add some items to your cart to proceed with checkout.</p>
            <Link
              href="/products"
            ...
            <div className="flex items-center justify-center gap-4 md:gap-8">
              {[
                ...
                <div key={s.num} className="flex items-center">
                  <div className="flex flex-col items-center">
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center font-semibold transition-colors ${
                        step >= s.num ? "bg-primary text-primary-foreground" : "bg-muted text-foreground/40"
                      }`}
                    >
                      {s.num}
                    </div>
                    <span
                      className={`text-sm mt-2 ${step >= s.num ? "text-foreground font-medium" : "text-foreground/40"}`}
                    >
                      {s.label}
                    </span>
                  </div>
                  {idx < 2 && (
                    <div
                      className={`w-16 md:w-24 h-1 mx-4 transition-colors ${step > s.num ? "bg-primary" : "bg-muted"}`}
                    />
                  )}
                </div>
              ))}
                    ...
                    <div className="pt-6">
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          { id: "express", label: "Express Shipping", time: "2-3 business days", cost: 15 },
                          { id: "overnight", label: "Overnight Shipping", time: "Next business day", cost: 25 },
                        ].map((method) => (
                          <label
                            key={method.id}
                          ...
                          >
                            ...
                            <p className="font-semibold">{method.cost === 0 ? "FREE" : `$${method.cost}`}</p>
                          </label>
                        ))}
                      </div>
                    </div>
                ...
                <div className="bg-card rounded-lg p-6 border border-border">
                  ...
                  <form onSubmit={handlePaymentSubmit} className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 p-4 bg-muted/50 rounded-lg">
                      ...
                      <p className="text-sm text-foreground/70">Your payment information is encrypted and secure</p>
                    </div>
                  ...
                  <div className="bg-card rounded-lg p-6 border border-border">
                    ...
                    <div className="mb-6 pb-6 border-b border-border">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button onClick={() => setStep(2)} className="text-sm text-primary hover:underline">
                          Edit
                        </button>
                      </div>
                      <div className="text-sm text-foreground/70">
